# Copy from mxnet official tool im2rec.py
# Support force-resize
...
def parse_args():
    ...
    cgroup.add_argument('--force-resize', type=bool, default=False, help='If this is set as True, \
        image will be resized to size: (--resize,--resize)')
